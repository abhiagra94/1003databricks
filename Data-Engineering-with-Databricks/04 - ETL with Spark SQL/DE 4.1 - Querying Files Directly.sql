...
select * from csv.`/mnt/rggentwo4521/Folder1/Department.csv`

-- COMMAND ----------

-- MAGIC %fs ls /mnt/rggentwo4521/Folder1/

-- COMMAND ----------

SELECT * FROM csv.`/mnt/rggentwo4521/Folder1/`



-- COMMAND ----------

CREATE OR REPLACE TEMP VIEW department_view
AS SELECT * FROM csv.`/mnt/rggentwo4521/Folder1/`;

SELECT * FROM department_view

-- COMMAND ----------

SELECT * FROM text.`/mnt/rggentwo4521/Folder1/`



-- COMMAND ----------

SELECT * FROM binaryFile.`/mnt/rggentwo4521/Folder1/`
