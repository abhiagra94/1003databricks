...
-- MAGIC %fs ls /mnt/input_2323

-- COMMAND ----------

-- MAGIC %scala
-- MAGIC val df = spark.read.format("csv").option("header","true").option("path","/mnt/input_2323/Department.csv").load
...
-- MAGIC %scala
-- MAGIC df.write.mode("overwrite").saveAsTable("learning.departmentnd")
...
-- MAGIC %scala
-- MAGIC display(dbutils.fs.ls("dbfs:/user/hive/warehouse/learning.db/department"))
...
drop table departmentnd

-- COMMAND ----------

-- MAGIC %scala
-- MAGIC df.createTempView("department")

-- COMMAND ----------

create table department as select * from department

-- COMMAND ----------

create table if not exists department as select * from department
...
-- MAGIC %scala
-- MAGIC df.write.mode("overwrite").option("path","/Filestore/tables/externaltable/externaldepartment/").saveAsTable("externaldepartment")

-- COMMAND ----------

select * from externaldepartment

-- COMMAND ----------


describe detail externaldepartment

-- COMMAND ----------

-- MAGIC %scala
-- MAGIC display(dbutils.fs.ls("dbfs:/Filestore/tables/externaltable/externaldepartment"))

-- COMMAND ----------

drop table externaldepartment

-- COMMAND ----------

create external table if not exists extdepartmentview
location '/Filestore/tables/extdepartment/externaldepartmentview'
select * from department

-- COMMAND ----------

-- MAGIC %scala
-- MAGIC val df1=spark.table("extdepartmentview")

-- COMMAND ----------

-- MAGIC %scala
-- MAGIC df.createTempView("tempdepartment")

-- COMMAND ----------

-- MAGIC %scala
-- MAGIC val df1=spark.table("tempdepartment")

-- COMMAND ----------

create database learningblobmanaged02
location '/mnt/input_2323/new_db_19_11'
...
-- MAGIC %scala
-- MAGIC df.createTempView("blobdepartmentt")

-- COMMAND ----------

use learningblobmanaged02
...
create table manageddepartment0102
select * from blobdepartment

-- COMMAND ----------

describe detail manageddepartment

-- COMMAND ----------

drop table manageddepartment

-- COMMAND ----------

select * from blobdepartmentt


-- COMMAND ----------

create external table extdepartmentblobtry
location '/mnt/input_2323/new_db_19_11/extdepartmentblobtry'
select * from blobdepartmentt

-- COMMAND ----------

UPDATE extdepartmentblobtry
SET Name='IT'
Where Department_id='4'

-- COMMAND ----------

describe detail extdepartmentblob
...
drop table extdepartmentblob

-- COMMAND ----------

create table extdepartmentblobmanagedtry
select * from blobdepartment

-- COMMAND ----------

select * from extdepartmentblobmanaged
...
drop table extdepartmentblobmanaged
